...
namespace NewFinanacialCodeFirst.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryId,BudgetId,Amount,IsDeleted")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryId,BudgetId,Amount,IsDeleted")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
